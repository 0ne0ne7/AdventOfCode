...
with open(input_path / "day5.txt", "r") as f:
    lines = f.read().split("\n")
    lines = [
        [int(i.strip()) for i in line.replace("->", ",").split(",")] for line in lines
    ]
    # print(lines)
...
def plot(lines, part=1):
    ...
    for line in lines:
        ...
        # print(f'slope for {line} is {slope}')
